...
MsgBox(0,'',@ProgramsCommonDir&'\CloudMounter\CloudMounter.lnk')
...
;~ 		if FileExists(@AppDataCommonDir&"\Package Cache\{9af3b5e1-ed1b-48df-a34f-22fa6bcc4b04}\DokanSetup.exe") then
;~ 			MsgBox(0,'','voy a desinstalar')
;~ 			ShellExecuteWait(@AppDataCommonDir&"\Package Cache\{9af3b5e1-ed1b-48df-a34f-22fa6bcc4b04}\DokanSetup.exe",'/uninstall /quiet',@AppDataCommonDir&"\Package Cache\{9af3b5e1-ed1b-48df-a34f-22fa6bcc4b04}\")
;~ 			MsgBox(0,'','ya desinstale')
;~ 		EndIf
...
;~ if $existe then
;~ 		MsgBox(0,'','$existe: '&$existe&@CRLF&'Cierro')
;~ 		Exit
;~ EndIf
