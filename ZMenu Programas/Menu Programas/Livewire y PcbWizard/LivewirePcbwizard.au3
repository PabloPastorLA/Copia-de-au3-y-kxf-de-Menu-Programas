...
$Instalador='Livewire y PCBWizard'
...
$NombrePrograma='LiveWire y PcbWizard'

;Ruta Instalacion.
$ruta='Livewire y PCBWizard'
...
If FileExists($Instalador) AND not FileExists ($ProgramFilesDir&'\'&$ruta) AND not FileExists ($ProgramFilesDir&' (x86)\'&$ruta) Then
	...
	DirCopy('Livewire y PCBWizard',$ProgramFilesDir&'\'&$ruta,0)

	FileCreateShortcut($ProgramFilesDir&'\'&$ruta&'\LIVEWIRE\Livewire.exe',@ProgramsCommonDir&'\Livewire.lnk',$ProgramFilesDir&'\'&$ruta&'\LIVEWIRE\')
	FileCreateShortcut($ProgramFilesDir&'\'&$ruta&'\PCB WIZARD\PCBWiz.exe',@ProgramsCommonDir&'\PCB Wizard.lnk',$ProgramFilesDir&'\'&$ruta&'\PCB WIZARD\')
