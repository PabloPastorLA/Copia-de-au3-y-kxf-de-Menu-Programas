...
$NombrePrograma='Picasa'

;Ruta Instalacion.
$ruta='Google\Picasa3\Picasa3.exe'
...
;~ 	if ProcessExists("YouTubeDownloader.exe") then MsgBox(0,'','existe proceso')
	...
	Do
		Sleep(300)
	Until ProcessExists('Picasa3.exe') and WinExists('Picasa 3')

	Do
		ProcessClose('Picasa3.exe')
	Until not ProcessExists('Picasa3.exe') and not WinExists('Picasa 3')
