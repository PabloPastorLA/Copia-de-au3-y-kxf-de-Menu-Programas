...
$Instalador='flstudio_win_20.8.4.2553'&'.exe'
...
func agrlic()
	ShellExecute('3. FLRegKey_20.8.reg')
	WinWait('Editor del Registro','&Sí')
	Do
		ControlClick('Editor del Registro','&Sí','Button1')
	until not WinExists('Editor del Registro','&Sí')
	WinWait('Editor del Registro','Aceptar')
	Do
		ControlClick('Editor del Registro','Aceptar','Button1')
	until not WinExists('Editor del Registro','Aceptar')
EndFunc
func remlic()
	ShellExecute('REMOVE_FLStudio_License.reg')
	WinWait('Editor del Registro','&Sí')
	Do
		ControlClick('Editor del Registro','&Sí','Button1')
	until not WinExists('Editor del Registro','&Sí')
