SplashTextOn('Espera','Autoit corriendo ' & @crlf & 'Inst Driv Energ G3',160,80,0,110)
if @OSVersion <> "WIN_XP" Then
	#RequireAdmin
EndIf


FileWrite(@DesktopDir & "\Bien Instalado.txt","Empecé a instalar:	Energ G3"&@CRLF)
...
FileWrite(@DesktopDir & "\Bien Instalado.txt","Terminé de instal:	Energ G3"&@CRLF)





FileWrite(@DesktopDir & "\Bien Instalado.txt","Empecé a instalar:	Drivers G3"&@CRLF)
...
FileWrite(@DesktopDir & "\Bien Instalado.txt","Terminé de instal:	Drivers G3"&@CRLF)
