SplashTextOn('Espera','Autoit corriendo ' & @crlf & 'DPInst G5',160,80,0,110)
...
FileWrite(@DesktopDir & "\Bien Instalado.txt","Empecé a instalar:	Energ G5"&@CRLF)
...
FileWrite(@DesktopDir & "\Bien Instalado.txt","Terminé de instal:	Drivers G5"&@CRLF)
...
func ConGUI()
	...
	ShellExecute('dpinst'&$64&'.exe','','G5 '&@OSVersion&' '&@OSArch)
