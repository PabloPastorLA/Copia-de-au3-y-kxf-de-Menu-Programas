SplashTextOn('Espera','Autoit corriendo ' & @crlf & 'Inst Driv Energ G9',160,80,0,110)
...
FileWrite(@DesktopDir & "\Bien Instalado.txt","Terminé de instal:	Energ G9"&@CRLF)





FileWrite(@DesktopDir & "\Bien Instalado.txt","Empecé a instalar:	Drivers G9"&@CRLF)
