...
; --------------------------------------------
		...
		While not ControlListView('lusrmgr - [Usuarios y grupos locales (local)\Usuarios]','','SysListView321',"IsSelected",$cantwin-1)
			ControlListView('lusrmgr - [Usuarios y grupos locales (local)\Usuarios]','','SysListView321',"Select",$cantwin-1)
		WEnd
;MsgBox(0,'','4')

			if @OSVersion='WIN_7' then $ventana='Propiedades: '&$usuarioactual
			if @OSVersion='WIN_10' then $ventana='Propiedades de '&$usuarioactual
