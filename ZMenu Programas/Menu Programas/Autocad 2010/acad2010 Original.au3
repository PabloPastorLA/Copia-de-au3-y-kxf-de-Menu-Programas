...
If FileExists("AutoCAD_2010_Spanish_MLD_WIN_32bit.exe") AND not FileExists (@ProgramFilesDir & "\AutoCAD 2010\acad.exe")  Then
	ShellExecute("AutoCAD_2010_Spanish_MLD_WIN_32bit.exe")
	ProcessWait('AutoCAD_2010_Spanish_MLD_WIN_32bit.exe')



	While ProcessExists('AutoCAD_2010_Spanish_MLD_WIN_32bit.exe')
		sleep(1000)
