...
$Instalador='Undelete-Setup-Ultimate'&'.exe'
...
$NombrePrograma='Active Undelete 19'

;Ruta Instalacion.
$ruta='LSoft Technologies\Active@ UNDELETE Ultimate\Undelete.exe'
$rutasola='LSoft Technologies\Active@ UNDELETE Ultimate\'
...
;Copiar CRACK
	if FileExists ($ProgramFilesDir&'\'&$ruta) and @OSArch='x86' then
		FileCopy('Crack32\SETTINGS.INI',$ProgramFilesDir&'\'&$rutasola&'SETTINGS.INI',9)
		FileCopy('Crack32\winmm.dll',$ProgramFilesDir&'\'&$rutasola&'winmm.dll',9)
	elseif FileExists ($ProgramFilesDir&'\'&$ruta) and @OSArch='x64' then
		FileCopy('Crack64\SETTINGS.INI',$ProgramFilesDir&'\'&$rutasola&'SETTINGS.INI',9)
		FileCopy('Crack64\winmm.dll',$ProgramFilesDir&'\'&$rutasola&'winmm.dll',9)
	ElseIf FileExists ($ProgramFilesDir&' (x86)\'&$ruta) Then
		FileCopy('Crack32\SETTINGS.INI',$ProgramFilesDir&' (x86)\'&$rutasola&'SETTINGS.INI',9)
		FileCopy('Crack32\winmm.dll',$ProgramFilesDir&' (x86)\'&$rutasola&'winmm.dll',9)
	Else
