...
If FileExists(@ProgramFilesDir & "\Winamp\UninstWA.exe") or FileExists(@ProgramFilesDir & " (x86)\Winamp\UninstWA.exe") Then



if FileExists (@ProgramFilesDir & "\Winamp\UninstWA.exe") Then
	ShellExecute(@ProgramFilesDir & "\Winamp\UninstWA.exe")
ElseIf FileExists (@ProgramFilesDir & " (x86)\Winamp\UninstWA.exe") Then
	ShellExecute(@ProgramFilesDir & " (x86)\Winamp\UninstWA.exe")
EndIf


WinWait('Idioma de la Instalación')
WinActivate('Idioma de la Instalación')
WinWaitActive('Idioma de la Instalación')
ControlClick('Idioma de la Instalación','OK','Button1')


WinWait('Desinstalación de Winamp')
WinActivate('Desinstalación de Winamp')
WinWaitActive('Desinstalación de Winamp')
ControlClick('Desinstalación de Winamp','&Desinstalar','Button2')

WinWait('Desinstalación de Winamp','Winamp ha sido desinstalado de su computador')
WinActivate('Desinstalación de Winamp','Winamp ha sido desinstalado de su computador')
WinWaitActive('Desinstalación de Winamp','Winamp ha sido desinstalado de su computador')
ControlClick('Desinstalación de Winamp','&Terminar','Button2')

WinWaitClose('Desinstalación de Winamp','Winamp ha sido desinstalado de su computador')
