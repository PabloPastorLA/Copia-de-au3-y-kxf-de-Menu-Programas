...
$NombrePrograma='Fort Zombie'

;Ruta Instalacion.
$ruta='Fort Zombie\FortZombie.exe'
...
;MsgBox(0,'','0')
;Instalar silencioso
	ShellExecuteWait('PhysX_9.09.0814_SystemSoftware.exe',' /q')
	ShellExecuteWait('msiexec.exe',' /i "xnafx30_redist.msi" /qb')
